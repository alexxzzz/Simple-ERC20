...
contract ERC20 is IERC20 {
    ...
    function icreaseAllowance(address spender, uint256 addedValue) public virtual returns (bool){
        address owner = msg.sender;
    ...
    function decreaseAllowance(address spender, uint256 decreasedValue) public virtual returns (bool){
        ...
        require(currentAllowance >= decreasedValue, "ERC20: decreased allowance below zero");
        unchecked {
            _approve(owner, spender, currentAllowance - decreasedValue);
        }
        return true;
    }
    ...
    function _burn(address account, uint256 amount) internal virtual {
        require(account != address(0), "ERC20: bun from the zero address");
